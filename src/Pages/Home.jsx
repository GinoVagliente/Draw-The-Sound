...
const Home = () => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-b from-[rgb(250,219,197)] to-[rgb(255,147,123)] flex flex-col items-center justify-center md:pl-20 md:pr-20">
