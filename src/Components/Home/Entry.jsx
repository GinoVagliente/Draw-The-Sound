      ...
      <div className="relative w-full">
        ...
        <div className="flex flex-row items-center gap-2 rounded-full bg-gradient-to-b from-[rgb(255,198,150)] to-[rgb(255,160,120)] border-[3px] border-[#7a4b2e] relative z-10">
          ...
          <button
            ...
            disabled={loading}
            className="cursor-pointer bg-[#7a4b2e] text-[#FFC19E] p-2 md:p-3 mx-5 rounded-xl hover:bg-[#FFC19E] hover:text-[#7a4b2e] transition-all duration-200 flex items-center justify-center disabled:opacity-50"
          >
